...
- **Fueling — THE takeaway, and it's the binding constraint for the marathon (see NUTRITION_GUIDE Presidio entry).** Plan was 3 gels carried / 2 taken (start + ~mi 6.5). **Actual: one gel, at ~65 min, coming back over the bridge.** Root cause is a real, repeatable pattern: *"Hard to convince myself to take gels when my HR is above 155, nearly impossible above 160."* At HM/MP effort HR lives in exactly that 150–165 band, so the standing every-30-min plan collided with effort-suppressed appetite and most of the fuel never went in. **Downstream effects, textbook under-fueling:** (1) **a cramp on the Presidio descent to the bridge** that *"started to throw me off"* and made him *"nervous about eating or drinking much after that"* — a fueling/hydration deficit feeding a vicious cycle (cramp → eat less → deeper deficit); (2) the **last ~4 miles "tired, hard to push, almost sleepy, hard to stay motivated"** — that flat, sleepy, no-pain de-motivation is the classic glycogen-depletion signature, not a toughness gap; (3) **walked the mile-10 aid station ~30 s for water and "that helped a bit"** — a hydration/fuel top-off producing immediate relief is more confirmation the tank was the limiter.
...
- **Hydration:** *"Hydration and gels were a bit hard."* June Presidio mornings are cool/foggy so absolute fluid need was on the low end, but combined with the near-zero gel intake the deficit still bit (the cramp + the mile-10 walk-and-drink relief). Single handheld + ½–¾ LMNT was the plan; confirm intake when folding the data.
