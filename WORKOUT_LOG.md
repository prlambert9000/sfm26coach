...
- **Athlete report:** *"Brutal. Hot to start. Ran the single-track trail along Cañada road for shade — added a lot of undulations and technical footing. Turned around at 8mi, couldn't pick up the pace much at all due to terrain + heat. Started to feel worse at 9mi, got hot and dizzy, by 10.7mi had to walk. Walk/run the rest of the way home — sometimes walking up hills with HR still 140–150. Good I brought extra water or I'd have been in trouble. Full week of travel with bad eating/drinking/sleep the week before probably didn't help. **Left at 2:30 PM and skipped lunch** — hadn't eaten much, ran at a very different time than usual."*
- **Knee Status:** **1/5 — green. Totally fine.** Streak holds — every V6 run 1/5 except the two loaded-squat 2/5s.
- **Right hamstring — THIRD appearance, promote to watch item.** *"Light hamstring twinges near the end — not sure if a cramp or related to the light pain I've been feeling the last few weeks. Never got bad because I was walk/running, not pushing."* Timeline: Jun 24 (twinge in recovery from Presidio HM) → Jul 1 (brief mention during/after threshold reps) → **Jul 5 (light twinges late during walk/run).** Three faint appearances in 11 days, all right side (same leg as the knee). Still not interfering with mechanics, all self-resolving, but the pattern is now clear enough to name and act on: (1) add posterior-chain warm-up to pre-run activation (dynamic leg swings, walking hamstring reach); (2) foam roll posterior chain daily; (3) avoid aggressive static stretching of an irritated hamstring; (4) watch on peak-volume work this week (48 mpw was scheduled); (5) escalate to PT if it sharpens, alters gait, or moves from "twinge" to a pull sensation.
- **FUELING — validated, and this is the biggest single finding of yesterday.** Actual intake:
  - Maurten Gel 100 @ T−5 · @ 25 min · @ 50 min · @ 1:15 · @ 1:50 = **5 gels × 25 g = 125 g of gel carbs**
  - Maurten Drink Mix 160 in the handheld (40 g), sipped throughout, finished during the last mile (~2:40) — call it ~30 g absorbed by 1:50, all 40 g by 2:40
  - **~155 g total over ~2 hr = ~78 g/hr through mi ~14, in the 70–80 g/hr race-day band. GI clean.**
  - **4 gels IN-RUN at effort** (mi ~3, 6, 8.5, ~11 — the last one taken *after* the wheels started coming off). This is exactly the "gel-at-effort" validation that Presidio said was the binding constraint for the marathon. It just happened. **The Jul 12 dress-rehearsal question mark on fueling is effectively answered — YES, at ~78 g/hr including 2 gels during MP-effort HR territory.**
- **What actually happened, physiologically — this was heat + pre-run undereating, not underfueling, not a fitness collapse.** Three evidence chains: (1) **HR was DROPPING while effort was going UP** — HR came down from ~150 (mi 10) to 139–143 (mi 12–15) while pace blew out from 10:00 to 11:30+/mi. Same signature as Presidio — depletion caps output, low HR is the *symptom*. But the depletion mechanism here is **pre-run** (skipped lunch, 2:30 PM start on already-low glycogen), not in-run (fueling was excellent). (2) **Total Z4 time: 39 seconds all day** — engine never worked at threshold. Max HR 160, under the 168 H10 floor. Not a race-effort read; a heat cap on an easy-to-steady run. (3) **HR 140–150 walking a hill in heat is normal** — heat lifts HR 5–10 bpm at any workload, cumulative dehydration drives it further.
- **The confounders (all controllable, all absent on race day):** (a) **2:30 PM start — peak afternoon heat.** Race is 5:30 AM. (b) **Skipped lunch** — started with a partially-empty glycogen tank *before* the run even began. Race morning is a proper 3–4-hr-out carb breakfast on a rested night. (c) **Technical single-track** — high aerobic cost + stabilizer load. Race is paved. (d) **Prior travel-week deficit** — bad sleep/food/drink pre-loaded the depletion. Race week is a controlled taper. (e) **Not heat-acclimatized** — first hot day of the build.
- **Plan-relevance verdict:** yesterday's meltdown was produced by four confounders that will NOT be present on race day. The fueling protocol validated. The engine is intact. The knee streak holds. Yesterday is not a race-day preview — it's a preview of *"what happens if you run in the afternoon heat on an empty stomach on a technical trail after a bad prior week,"* which is not something Paul will do on July 26.
- **What genuinely stays open:** (a) the **mental piece** Paul flagged (*"dreading it a bit"*) — no data point can settle that; (b) the **right hamstring pattern** — three faint appearances now; (c) **heat acclimation** — should push a few deliberate warm-hours-of-day runs in the next 10 days if July 26 forecasts warm.
- **Coaching read — the fueling breakthrough materially strengthens the case for running the full.** The single biggest question mark hanging over marathon day just got answered positively — 78 g/hr including gels-at-effort, GI clean, on a hard day. What broke yesterday was 100% controllable pre-run choices in conditions that don't match race day. So the earlier "fueling unproven → half is safer" logic is largely retired. The remaining questions are motivation (only Paul can answer) and the hamstring (address proactively this week). Separate response to Paul walks back the earlier First Half lean given this new data; his call on race format still pending.
...
- **Type:** Race (half marathon, Pivot test). Strava sidecar landed: `strava/activities/19013007310.json`.
- **The numbers (watch):** **12.945 mi** (GPS read short — Paul confirms he ran the full 13.1; the Golden Gate Bridge towers/cables scatter GPS, so the short read is a bridge artifact, not missed distance) in **1:38:03 moving / 1:38:19 elapsed** · avg **7:34/mi** moving (~7:30/mi over the true 13.1) · avg HR **155.1** (H10) · **max 164** · +555 ft · avg power 268 W · **suffer 235** (highest in the V6 log) · 1,409 cal.
- **HR zones:** Z1 (≤116) 0:14 · Z2 (117–144) 2:24 · **Z3 (145–158) 74:14** · Z4 (159–173) 21:11 · **Z5 0:00.** Controlled threshold-shaped effort, **never redlined** — max 164 all day (< the 168 H10 floor, no max-HR implications), zero Z5, no end-of-workout spike (clean trace). **He was not limited by hitting an HR *ceiling* — he was limited by depletion, which *suppressed* his HR** (he reports he couldn't drive it higher in the close even trying). The empty tank capped his output below his aerobic ceiling.
- **Splits (mi: pace / HR / elev):** 1: 7:30 / 146 / −5 · 2: 7:22 / 155 / +1 · 3: 7:18 / 157 / +1 (quick early, on sub-1:37 pace) · **Presidio climb →** 4: 8:13 / 159 / **+163** · 5: 8:22 / 158 / **+156** · **descent to bridge →** 6: 6:33 / 158 / **−182** *(the side stitch hit here; pace flatters via downhill + bridge GPS underread)* · 7: 7:59 / 158 / +107 · 8: 7:51 / 153 / −18 · 9: 7:31 / 156 / +34 · 10: 7:10 / 154 / −153 *(walked the aid station ~30 s in here)* · **11: 7:49 / 150 / −111 · 12: 7:43 / 154 / +1** *(the fade — pace slowing while HR **drops** to 150–154 = the under-fueling signature, a tank/legs limit, not a cardiac one)* · 13: 7:10 / 159 / −11 (small finish push).
- **GATE SCORECARD — 2 of 3 passed; the time gate missed, so officially hold 3:30:**
  - **Gate 1 (sub-1:37:30 finish): MISSED.** Watch 1:38:03 moving / 1:38:19 elapsed — short of the gate by ~35–50 s. *Official chip time TBD (Paul to confirm from race results) but it will land ~1:38.* **Critical nuance:** 1:38:19 sits **right on the 1:38:20 break-even line** (the HM time = same fitness as a 3:25 marathon). So per the plan's bands this is a **coin-flip 3:25, not a clear "no"** — the confident-3:25 margin (sub-1:37:30) wasn't there, but the *fitness* for 3:25 demonstrably was.
  - **Gate 2 (avg HR <170 final 3 mi): PASSED — but it's a *hollow* pass (corrected Jun 21 per athlete).** Final 3 mi (miles 11/12/13) avg HR **154.6**, 15 beats under the ceiling. **Do NOT read this as cardiac reserve.** Paul: *"It was in the 150s for the last 3 miles not because I was holding back, but because I genuinely couldn't bring myself to push it higher."* The suppressed HR was **depletion-locked, not a choice** — a glycogen-depleted/fatigued runner physiologically *can't* drive HR to the top of the range (the legs/CNS can't generate the output). So the low HR is **another symptom of the under-fueling, not evidence he had a gear in reserve.** It clears the gate on paper, but the *reason* it cleared is exactly the problem we need to fix.
  - **Gate 3 (zero knee compensation): PASSED.** Knee 1/5, no pain at any point, *"feels good now too"* hours later. On a hilly bridge course with real descent load — the #1 risk stayed quiet.
- **Knee Status:** **1/5 — PASSED the zero-knee-comp gate.** No pain reported at any point — the late-race struggle was *"not pain, just not really wanting to push."* On a hilly bridge out-and-back with real eccentric descent load (the Presidio drop to the bridge), zero knee compensation crossing the line is the single most important outcome of the day and **it held.** Streak holds (every V6 session 1/5 except the lone Boston-stairs 2/5 and the Jun 17 squat 2/5).
- **Course-compromised time — bridge traffic forced near-walks.** *"Bridge traffic was insane, I had to slow down to almost a walk for bits of it because of all the people."* The out-and-back bridge sections are a known pedestrian-congestion choke; near-walking through crowds is dead time bolted onto the clock that has nothing to do with fitness. A sub-1:37:30 miss "by under a minute" with multiple forced near-walks means **the engine was capable of the gate time on a clear course** — the clock is course noise here, not a fitness verdict.
- **Side stitch (corrected Jun 21 — Paul clarified "cramp" was a *side stitch*, NOT a muscle cramp):** an **ETAP-type stitch under the right ribs** that came on during the Presidio→bridge descent, *"slowed my descent and impacted my mentality,"* and *"eventually went away."* This is its own mechanism, distinct from under-fueling: side stitches are typically diaphragm/breathing-related, aggravated by descent jostling and by recent food/fluid intake, and they resolve on their own — they are **not** an electrolyte or glycogen signal. **Its real damage here was behavioral:** it made him *"nervous about eating or drinking much after that,"* which kicked off the under-fueling spiral below. So the stitch didn't *prove* a deficit — it *caused* one by scaring him off the gels. (Next-time levers: controlled belly breathing / exhale on the foot-strike opposite the stitch side, shorten stride and stay tall on descents, and avoid a large gel/fluid bolus right before a downhill.)
- **Fueling — THE takeaway, and it's the binding constraint for the marathon (see NUTRITION_GUIDE Presidio entry).** Plan was 3 gels carried / 2 taken (start + ~mi 6.5). **Actual: one gel, at ~65 min, coming back over the bridge.** Two compounding causes: (a) the standing every-30-min plan collided with effort-suppressed appetite — *"Hard to convince myself to take gels when my HR is above 155, nearly impossible above 160,"* and HM/MP effort lives in exactly that 150–165 band; (b) the side stitch above made him gun-shy about eating/drinking for the back half. **Downstream effects, classic under-fueling:** (1) the **last ~4 miles "tired, hard to push, almost sleepy, hard to stay motivated"** — that flat, sleepy, no-pain de-motivation is the glycogen-depletion signature, not a toughness gap; (2) **walked the mile-10 aid station ~30 s for water and "that helped a bit"** — a hydration/fuel top-off producing immediate relief is confirmation the tank was the limiter.
- **Athlete idea — caffeine gels (good, adopt it):** *"Might want to look at caffeine gels next time, didn't have any this time."* Correct instinct. PF30 Caffeine (+100 mg) is already in the system for late-race kicks; caffeine also blunts perceived effort, which directly attacks the "can't make myself fuel at high HR" problem. Logged into NUTRITION_GUIDE as a Phase-2 fueling lever.
- **Hydration:** *"Hydration and gels were a bit hard."* June Presidio mornings are cool/foggy so absolute fluid need was on the low end, but combined with the near-zero gel intake the deficit still bit (the sleepy close + the mile-10 walk-and-drink relief). Single handheld + ½–¾ LMNT was the plan; confirm intake when folding the data.
- **Strava sidecar:** `strava/activities/19013007310.json` · [activity](https://www.strava.com/activities/19013007310). Cadence null per the known Apple→Strava gap — hand-fold from Apple Fitness if Paul shares the screenshot.
- **Coaching read — you didn't fail today; you found the one thing that decides the marathon.** Honest verdict, no sugar: the time gate was missed, so per the locked rules we **hold 3:30, not 3:25.** But that's the *least* informative thing that happened. The three things that actually matter: **(1) the knee passed clean on a hilly bridge course with descent load — the #1 risk stayed quiet, which is the whole ballgame.** **(2) The time miss was the thinnest possible — 1:38:19 elapsed sits right on the 1:38:20 break-even line, with bridge-crowd near-walks, a side stitch, and one gel of fuel all dragging on the clock.** the final-3-mi HR sat at 154 not because he paced it there but because, depleted, he *couldn't drive it higher* — the empty tank capped his output. So he was **fuel-limited, and the suppressed HR is the fuel limit showing up,** not spare engine.** So 3:25 isn't dead, it's **deferred to a cleaner read** — the break-even-line fitness is there on paper, but the only way to know what a *fueled* Paul runs is to fix the fueling and get a clean day. That's the whole project for the back half. **(3) You discovered the binding constraint for July 26 five weeks early, while it's still fixable:** you cannot fuel at HM/marathon effort yet — one gel in 97 minutes, a side stitch that scared you off the gels, and a glycogen-flat final 4 miles. **A 3.5-hour marathon on today's fueling pattern bonks hard around mile 18–20.** That is now the #1 training priority for the back half of the build — bigger than any pace target. The flat, sleepy, "didn't want to push" close was not a mental weakness; it was an empty tank, and an empty tank is a solvable engineering problem (caffeine gels, fueling *before* HR climbs, practicing intake at effort, maybe a drink-mix format that goes down easier than gels at high HR). **Forward:** rest today, easy spin/walk if anything, and we re-architect the fueling protocol around the high-HR-appetite problem this week. The pivot says hold 3:30 — but the marathon prep just got a lot smarter for it.
...
- **Rep breakdown (Apple Fitness Intervals — ground truth, athlete-provided):** WU jog to track (2.34 mi / 19:48 / HR 133 / 168 spm). Then 3×1600m on the flat oval, dead-even and dialed: **Rep 1** *(watch mislabeled it "Unknown Goal" — lap fired a hair early, but it was a clean 1600m)* **7:06 (7:13/mi)** · HR 155 · 281 W · **173 spm** · **Rep 2** **7:07 (7:09/mi)** · HR 158 · 275 W · **174 spm** · **Rep 3** **7:09 (7:12/mi)** · HR 158 · 274 W · **174 spm**. Recoveries 2:00 each (HR 149 / 151 / 155). CD jog home (2.19 mi / 19:46 / HR 149 / 167 spm, +175 ft uphill). **All three reps 7:06–7:09 (7:09–7:13/mi) — slightly faster than the 7:15–7:25 target, with near-identical splits and HR pinned at 155–158.** Textbook even-paced threshold control.
- **Cadence (Apple Fitness — Strava JSON null per known gap):** reps at **173–174 spm**, WU/CD 167–168 — good turnover under the threshold load, climbing ~6 spm from jog to rep pace as expected.
- **Strava-lap note (track GPS underread):** Strava's lap data merged rep 1 with its recovery and read the rep distances short (~1574–1588m for the watch's 1600m), biasing its computed lap paces slow. Apple Fitness uses the true 1600m boundaries — figures above are from Apple and supersede the Strava lap paces.
...
- **Knee Status:** **1/5 — green.** "Knee was good, one out of five." Streak holds — every V6 session 1/5 except the single 2/5 on Boston stairs. The fast-finish gates (knee 1/5 AND fuel sitting well) were met, and the closing 7:27–7:29 miles produced zero knee compensation. Cleanest possible read on the longest run since B2B.
- **Fueling (gut-training rehearsal #1) — Precision Fuel PF 30 gels (30 g carb each), current system:** protocol is 1 gel at T−5→0 (pre-start), then 1 every 30 min. **Today executed: gels at start, 30 min, 60 min = 3 × PF30 = 90 g.** The 90-min gel **came due during the MP fast-finish and was skipped — a focus/pacing call ("couldn't mentally get there, wanted to keep pace"), NOT a GI issue.** No GI distress; gut handled three gels clean. **Actual ~50 g/hr** (90 g over ~1:47); had the 4th landed it would've been ~4 × 30 g ≈ **67 g/hr**, right at the 65 g/hr target. Takeaway: the gut tolerated the dose fine — the only miss was the logistics of taking a gel mid-fast-finish. **Forward fueling cue:** pre-load the back-half gel *before* the MP push kicks in (e.g., take the ~90-min gel a few minutes early, around mile 10 before the surge) so the fast-finish focus doesn't cost a feeding.
- **Notes:** **Strong session — the headline is the HR discipline, and the knee + gut both checked out.** The whole point of this run was to break the May 24 pattern of running the easy miles too hard, and he did: 10 miles at HR 132–143 under a 155 cap is exactly the aerobic investment Phase 2 volume wants, and it left enough in the tank to close three miles at 7:27–7:29 with the knee at 1/5. **Correction (logged June 7): an earlier note here said to "hold the leash" on the MP close because the pace (7:27–7:29) beat the 7:35–7:45 readout — that was pace-anchored and is retracted.** Under the plan's HR-primary rule, MP HR sat squarely in the 150–160 band (152–157, never breaking 160 until a brief end kick), so this was a *correctly-governed* MP effort; the quick pace is a **fitness readout** (current flat-ground MP-effort pace ≈ 7:28, ahead of the VDOT 54 goal pace), not over-pacing. Nothing to rein in — HR held the band. The one real action item: (2) the skipped 90-min gel was a focus-vs-fueling tradeoff during the surge — solve it by feeding *before* the fast finish starts. Longest run since B2B, executed clean on flat ground after two unplanned Boston rest days converted into freshness. **All open items resolved: knee 1/5, gut tolerated 3 gels, no GI distress.**
...
- **Illness status (reported AM, day 2 of cold):** Light cold, a bit more stuffed up than Wed, poor sleep, energy off. Passes the neck test (above-the-neck, no chest involvement, no fever). Athlete feeling **optimistic about Saturday PAL 10K** — playing it safe with the skip today to bank extra rest, not because the run was off the table.
- **Notes:** Right call, easy call. Skipping a 4 mi aerobic maintenance run 2 days out from a benchmark race carries zero training cost — 4 mi at HR 145 isn't a fitness driver, it's a routine-keeper. With a cold in the system and poor sleep last night, the value of an extra rest day is materially higher than the value of running the prescribed session. The asymmetry favors rest. Strides drop was already in the brief; dropping the 4 mi alongside is a clean conservative extension of the same logic. **Saturday PAL 10K:** still on the table per athlete read. Friday AM + Friday night remain the formal decision points — the five-point checklist holds (no fever 24 hr / above-neck only / RHR within 5 bpm of baseline / energy near-normal / symptoms clearly improving). If symptoms keep their current light trajectory and improve through Friday, it's a go. If the cold sharpens or RHR climbs, it's a DNS and we re-time the calibration. No need to call it today either way. **Today's priorities:** hydrate aggressively (electrolytes if available), zinc + Vit C, nap if a window opens, bed by 9:30. Track RHR tonight + Fri AM — that's the cleanest signal we'll get. Fri is full rest regardless, so the schedule absorbs this skip without disruption.

## May 27, 2026

- **Workout:** Wed Maintenance Strength, taper-light (V6 Week 4 — PAL 10K race week, 3 days out)
- **Type:** Gym (Cañada College, ~35–40 min — taper-light: 60% loads, 2 sets)
- **Executed:** Back squat 100 lb 2×6, RDL 100 lb 2×6, standing calf raise 25 lb/hand 2×10, reverse Nordic **skipped per Rx** (taper protocol). **PT block appended and completed:** side plank w/ hip abduction (top toe down), dead bug w/ banded pulldown, chin tuck + lifts. All Rx, no deviations.
- **Knee Status:** **1/5 — green throughout.**
- **Illness flag (reported 7:12 AM PT, post-session):** Athlete started feeling a cold coming on Tuesday evening (scratchy throat) and woke up Wed with **light cough + some phlegm**. Source: son had a runny nose all weekend → pediatric viral URI exposure, 24–48 hr incubation. Symptoms are **above-the-neck, mild**, but the productive cough/phlegm is borderline and needs watching. Wed AM strength session went down before symptoms escalated and at taper-light intensity — fine in retrospect, but **no further activity today.** Rest, hydration, early bed.
- **Notes:** Clean Rx delivery of the taper-light stimulus — exactly the "rehearsal, not a workout" the V6 protocol is designed for at 60% loads × 2 sets. **The headline is the PT block.** The briefing specifically called for the PT block (side plank w/ hip abd, dead bug w/ banded pulldown, chin tuck + lifts) to be tacked on since Friday is full rest, and it landed — third consecutive session where the PT exercises got their full dose after slipping the last two Fridays to time crunches. Those are the highest-leverage exercises for the medial PFJ diagnosis, and getting them in during race week is the right way to enter the PAL 10K. No load-progression signal generated by design (taper sessions don't test). Working weights all hold for the post-race normal-load Wed on June 3: squat 165, RDL 165, calf raise 40 (rack-blocked from 45), Bulgarian 25 lb/hand, SL-RDL 25 lb contralateral; reverse Nordic resumes that day. Knee 1/5 through a light loaded session 3 days out from a benchmark race = systems all clear from a *musculoskeletal* standpoint. **The illness flag is now the binding constraint on race week, not the training plan.**
- **Race-week call (updated post-illness flag):**
  - **Today (Wed):** No additional activity. Rest, hydrate, bed by 9:30, zinc/Vit C if available. Baseline resting HR tonight.
  - **Thu AM:** Decision point for 4 mi easy + strides. Neck check: above-neck only + stable/improving + no fever + resting HR within 5 bpm of baseline → easy 4 mi conversational pace, **strides skipped**. Any worsening, chest involvement, fever, or RHR elevated >5 bpm → full rest.
  - **Fri:** Rest day regardless (was already Rx).
  - **Sat PAL 10K go/no-go (Friday night call, confirm Saturday AM):** Race only if ALL hold: (1) no fever in last 24 hr, (2) cough throat-only with no chest involvement, (3) RHR within 5 bpm of baseline, (4) energy near normal, (5) symptoms clearly improving not stable. **Any miss → DNS.** PAL 10K is a calibration race, not a target race; viral myocarditis risk is real and the non-catastrophic case still costs 2–3 weeks of training quality. Presidio HM is the actual Pivot in 3.5 weeks. Re-time the calibration to a future flat 10K (or use Presidio as the data point) — no scenario where forcing this race serves the marathon.
...
- **Type:** Gym (single-leg + isometrics, PT block skipped)
- **Executed:** Bulgarian split squat 3×10 (set 1 @ 20 lb/hand, sets 2–3 @ 25 lb/hand — mid-session bump above Rx 20), Single-leg RDL 25 lb contralateral 3×8 (lower end of 8–10 Rx range, no feel reported), Spanish squat hold (Rx, light band), Copenhagen plank (Rx, 3×30s each side). **Skipped (ran out of time): side plank w/ hip abduction (PT), dead bug w/ banded pulldown (PT), chin tuck + lifts (PT).**
- **Knee Status:** 1/5 — green throughout, including the 25 lb/hand Bulgarian split squats.
- **Notes:** Self-initiated load bump on Bulgarians (20 → 25 lb/hand mid-session, cleared 2×10 with knee 1/5) — that's a clear Easy-at-20 signal, mirrors the W1 pattern (15 → 20 mid-session) when he last progressed this lift. New working weight = 25 lb/hand. SL-RDL completed at the full prescribed 25 lb contralateral progression in the 8–10 range; no feel rating means we hold at 25 for next loaded Fri to capture a clean signal. Spanish squat and Copenhagen at Rx. The miss is the PT block — side plank, dead bug, chin tuck got dropped to the time crunch. That block is PT-prescribed, not optional, and it's the second Fri in a row with PT volume falling off (May 15 had them; today did not). Need to either move the PT block earlier in the session or carve out a 5-min dedicated slot for it. Otherwise a strong session: two progression signals in a normal-build W3, knee 1/5 across loaded single-leg work, clean execution. (W3 was promoted from deload to full build on May 15; W4 next week is the PAL 10K taper.)
...
- **Workout:** Bay to Breakers 15K (Week 2 benchmark) — "as much or more a party than a race"
- **Type:** Race / Run
- **Distance:** 9.33 mi (15K course only — no warmup/cooldown added)
- **Time:** 1:15:10
- **Avg Pace:** 8:03/mi
...
- **Knee Status:** 2/5 — mild awareness mid-race (small tweaks), no progression during/after, feels fine post-run. Within tolerance. Per protocol: double the mobility flush tonight (foam roll quads/IT band 2 min each, glute bridges 2×15, banded clamshells 2×15, 90/90 PAILs 45 sec each side). **Escalation rule:** two consecutive 2/5+ readings in the medial PFJ location (the exact PT-diagnosed spot) is a hard flag — bypass the standard "3+ → bike" gate, escalate to the 3/5 protocol (escape valve to bike/elliptical) and message Akanksha proactively. The location specificity matters — generic knee 2/5 is different from medial PFJ 2/5 given the diagnosis.
- **Course note:** Not the official Bay to Breakers (which is a 12K). This was the **Sports Basement Berkeley Run Club "Bay to Breakers + Bonus Breakers"** variant — the standard B2B course plus a bonus climb up **Point Lobos Ave toward Lands End Lookout** to make it a 15K. The "bonus" is the sharp spike visible at mile 8 in the elevation chart (~190 ft of climb in a quarter mile after the long descent through Golden Gate Park — a punishing placement).
- **Strava PR:** Fastest 15K of 2026 by 4:36. (First 15K of the year, but still on the board.)
- **Plan vs actual:** Plan was miles 1–6 @ 8:30–8:45 steady, miles 6–9.3 @ MP 7:35–7:45 (cap 7:35). Reality: crowded festive start made the early steady block impossible to execute as scripted — first 3 mi averaged 8:49 (Hayes Hill in mile 3 explains some). Once the field opened up, miles 6–7 dropped to 7:22 / 7:12 on the long descent through the Park. Mile 8 was the unscripted Point Lobos climb (+91 ft, 8:16 split). Recovered immediately with 7:14 + 6:19 kick.
...
- **Notes:** Smart adaptation — Paul ditched pace targets in favor of HR because the home loop has too much vertical for clean pace anchoring. Result is a textbook progression by effort. Easy section paced 8:30-ish (faster than the 9:00 flat target) but HR 136–149 is Z2–low Z3, squarely aerobic; the -131 ft mile 1 explains 8:02 at HR 136 (gravity, not effort). Threshold miles 7:38 / 7:42 are *slower* than the 7:15–7:25 flat target but HR 159–162 is genuine Z4 (88–90% of 180 max) — on a flat road that HR would deliver 7:15–7:25 *at VDOT 54 fitness*; current fitness is ~VDOT 52 (per May 3 5K), so 7:38–7:42 is today's actual LT pace, not a failed workout. Final 0.82 mi @ HR 163 / 114 ft of gain matches the plan's "switch to HR (155–162, cap 165)" instruction — executed to script. **Z4 time-in-zone = 19:30 (35% of session) is a substantial threshold dose for a "6 mi progression"** — hilly terrain plus HR-anchored execution pushed the aerobic stimulus closer to a tempo session. Z5 0:00 confirms the cap held under load. Max HR 167 mirrors Tuesday's track peak (also 167) — consistent ceiling under VO2 and threshold work, true max likely ~180. **Confounder logged:** Wed heavy squat session was felt in the legs at wakeup — residual neuromuscular fatigue likely depressed pace 5–10 sec/mi at correct HR. Polar H10 trace clean throughout. **Coaching takeaway:** drove the HR-first execution rule now codified in TRAINING_PLAN.md Section I.
...
- **Workout:** Lower A strength (Week 1, Day 1)
- **Type:** Gym
...
- **Avg Cadence:** 170 spm
- **Effort:** 8/10 (Hard)
- **Splits:** 8:11, 8:06, 8:23, 8:31, 9:19, 8:17, 8:09, 8:12, 8:41, 8:39, 7:37 (0.5)
- **Knee Status:** 🟡 Yellow — no pain during run, but "tingly and tender" afterward. Described as "awareness" not pain.
- **Notes:** Mile 5 was steep climbing (9:19, 219 ft gain). Finished strong with a 7:37 kick. Strava AI noted "pushed hard in threshold zones." This was not a planned training run — ran nearly double the intended distance after getting lost. Plan is to rest several days before Week 1 starts April 13.
...
- **Workout:** Grabbing the spare key
- **Type:** Run
- **Distance:** 1.28 mi
- **Time:** 10:29
- **Avg Pace:** 8:12/mi
- **Elevation Gain:** 77 ft
- **Avg Heart Rate:** 151 bpm (max 160)
- **Splits:** 7:46, 8:06
...
- **Avg Heart Rate:** 129 bpm (max 151)
- **Avg Cadence:** N/A
- **Splits:** 10:25, 10:01, 9:25, 9:30, 8:34, 8:36, 9:27
- **Relative Effort:** 42.0
...
- **Avg Heart Rate:** 146 bpm (max 167)
- **Avg Cadence:** N/A
- **Splits:** 7:49, 7:39, 7:58, 8:30, 8:55
- **Relative Effort:** 59.0
- **Strava sidecar:** `strava/activities/19418388845.json`
- **Knee Status:** (pending — update after reviewing)
- **Notes:** Auto-logged from Strava. Awaiting athlete feedback.
...
- **Avg Heart Rate:** 140 bpm (max 159)
- **Avg Cadence:** N/A
- **Splits:** 8:17, 7:55, 9:29, 8:43, 9:16
- **Relative Effort:** 46.0
- **Strava sidecar:** `strava/activities/19515606056.json`
- **Knee Status:** (pending — update after reviewing)
- **Notes:** Auto-logged from Strava. Awaiting athlete feedback.
...
- **Avg Heart Rate:** 146 bpm (max 161)
- **Avg Cadence:** N/A
- **Splits:** 9:36, 9:31, 7:47, 8:48, 8:19, 8:09
- **Relative Effort:** 86.0
- **Strava sidecar:** `strava/activities/19558001625.json`
- **Knee Status:** (pending — update after reviewing)
- **Notes:** Auto-logged from Strava. Awaiting athlete feedback.
...
- **Avg Cadence:** N/A
- **Splits:** 
- **Relative Effort:** 82.0
- **Strava sidecar:** `strava/activities/19656318495.json`
- **Knee Status:** (pending — update after reviewing)
- **Notes:** Auto-logged from Strava. Awaiting athlete feedback.
...
- **Avg Heart Rate:** 145 bpm (max 163)
- **Avg Cadence:** N/A
- **Splits:** 9:11, 9:23, 7:48, 7:35
- **Relative Effort:** 48.0
- **Strava sidecar:** `strava/activities/19711782384.json`
- **Knee Status:** (pending — update after reviewing)
- **Notes:** Auto-logged from Strava. Awaiting athlete feedback.
...
- **Avg Heart Rate:** 154 bpm (max 164)
- **Avg Cadence:** N/A
- **Splits:** 8:06, 7:49, 7:59, 8:17, 9:32, 8:40
- **Relative Effort:** 100.0
- **Strava sidecar:** `strava/activities/19779960069.json`
- **Knee Status:** (pending — update after reviewing)
- **Notes:** Auto-logged from Strava. Awaiting athlete feedback.
...
- **Avg Heart Rate:** 144 bpm (max 159)
- **Avg Cadence:** N/A
- **Splits:** 8:42, 13:03, 8:23, 8:18, 9:03
- **Relative Effort:** 72.0
