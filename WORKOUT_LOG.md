...
- **Structure executed:** Plan called miles 1–6 steady @ 8:30–8:45, miles 6–9.3 @ MP 7:35–7:45 (cap 7:35). Executed: miles 1–5 steady 8:08–8:54 (climb-heavy front half topping out near 264 ft at mile 4–5, HR 135–160), MP push miles 6–7 came in faster than prescribed (7:22 / 7:12) on net-downhill terrain (−196 ft combined). **Mile 8 was the self-added "bonus breaker"** — a steep spike up to the Sutro Baths / Lands End lookout (~190 ft of gain concentrated in roughly half a mile) to bring the race total to 15 km. Pace registered 8:16 at HR 177 on that climb, but per athlete report it was strong-effort uphill running, *not* late-race fatigue collapse — the climb itself was the cost, legs were fine. Mile 9 returned to 7:14 on the descent. Bonus 0.32 mi kick at 6:19 / HR 180 closed it out.
...
- **Notes:** Strong B2B execution and the most useful calibration data point we have since the May 3 5K. Avg HR 159 sustained over 75 min with Z4+Z5 = 39:32 demonstrates real threshold capacity — well above what the May 3 hilly solo 5K suggested. MP finish miles (7:22 / 7:12 / 7:14) came in faster than the 7:35 cap but with significant downhill aid (−309 ft over those 3 miles); on flat ground HR 162–173 would deliver more like 7:25–7:35 at current fitness. **Mile 8 reclassified per athlete report:** initial read called it late-race aerobic ceiling, but the elevation profile shows a single sharp ~190 ft spike (self-added Sutro Baths / Lands End bonus, not part of the official B2B course), and Paul reported strong legs throughout — this was a deliberate steep climb, not a fatigue tell. Net effect: the B2B suggests current sustainable threshold HR is *higher* than the conservative 170–175 read; aerobic ceiling probably sits closer to 175 with the closing 6:19/180 kick confirming the working max. **Closing kick HR 180 = working max confirmed.** Polar H10 trace clean throughout, max 185 is plausible peak (above the 180 working max used for zones — likely true max is 183–185, not 180). Cadence not reported (sensor dropout — unclear if foot pod or watch issue). **Knee read is the headline concern:** the tingle landed in the exact PT-diagnosed location (medial PFJ), not a generic ache, and persisted into the evening. This is the first knee reading above 1/5 since the V6 plan started May 4. Notably, mile 8's steep uphill (eccentric-heavy on the way back down too) is exactly the kind of load that lights up medial PFJ — the bonus climb may be the proximal cause. Protocol response: train as planned this week but **double the mobility flush** today (hip CARs, banded hip IR, glute bridges, foam roll quad/IT band). Two consecutive 2/5+ readings in this location is a hard flag — escalate to 3/5 protocol (escape valve to bike/elliptical) and message PT. Watch the Tue track session closely — if any medial knee awareness during 1000m reps, scratch the reps and convert to easy bike. **Coaching takeaway for PAL 10K:** the B2B confirms the 7:15–7:20 target is realistic on flat ground and lands toward the middle/fast end of that range at current fitness; sub-44:00 is a real possibility, not an outlier — would be a genuine VDOT 53–54 readout and would justify moving the Presidio Pivot gate. Sub-45:00 = on plan. Knee discipline through the next 13 days matters more than any pace target.
