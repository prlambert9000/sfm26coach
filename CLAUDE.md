...
- **Race:** SF Marathon, July 26, 2026. **Goal: 3:30 (8:00/mi avg on hilly SF course = 3:18 flat-equivalent = VDOT 54) — CONFIRMED as the committed target after the Presidio Pivot test (Jun 21).** The 3:20–3:25 upgrade (VDOT 56–57) was gated on three Presidio criteria; **result: 2 of 3 passed (HR<170 final 3 mi ✓, zero knee comp ✓), time gate MISSED — 1:38:19 elapsed vs sub-1:37:30 (right on the 1:38:20 break-even line).** So **hold 3:30** per the locked rule. **3:25 is deferred, not closed:** the time was dragged by bridge-crowd near-walks + a side stitch + near-zero fueling (1 gel), and HR had 15 beats of headroom (fuel/crowd-limited, not engine-limited) — revisit a 3:25 upgrade only off a cleaner fitness read later in the build. **The binding marathon constraint exposed Jun 21 is in-race fueling at high HR** (can't get gels down above HR ~155–160) — now the #1 training priority for the back half (see NUTRITION_GUIDE + WORKOUT_LOG Jun 21). Train paces stay at VDOT 54.
